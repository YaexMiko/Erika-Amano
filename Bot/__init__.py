...
BOT_TOKEN = os.environ.get('BOT_TOKEN', '7412589100:AAGdOwar7jHUS47fOx4nDVB5VcY2pI0LdjQ') #BOT Token Add
...
FILES_CHANNEL = os.environ.get("FILES_CHANNEL", -1002336754072)    # Must Fill This ,Add Bot As Admin In Log Channel
BOT_NAME = os.environ.get('BOT_NAME', 'Zero Test')
